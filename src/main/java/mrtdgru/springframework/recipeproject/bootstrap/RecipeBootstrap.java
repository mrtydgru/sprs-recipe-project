package mrtdgru.springframework.recipeproject.bootstrap;


import mrtdgru.springframework.recipeproject.domain.*;
import mrtdgru.springframework.recipeproject.repositories.CategoryRepository;
import mrtdgru.springframework.recipeproject.repositories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        checkUomIsPresent(eachUomOptional);

        Optional<UnitOfMeasure> tableSpoonUomOptional = unitOfMeasureRepository.findByDescription("Tablespoon");

        checkUomIsPresent(tableSpoonUomOptional);

        Optional<UnitOfMeasure> teaSpoonUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");

        checkUomIsPresent(teaSpoonUomOptional);

        Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.findByDescription("Dash");

        checkUomIsPresent(dashUomOptional);

        Optional<UnitOfMeasure> pintOumOptional = unitOfMeasureRepository.findByDescription("Pint");

        checkUomIsPresent(pintOumOptional);

        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasureRepository.findByDescription("Cup");

        checkUomIsPresent(cupsUomOptional);
        ...
        categoryOpitonalIsPresent(americanCategoryOptional);

        Optional<Category> mexicanCategoryOptional = categoryRepository.findByDescription("Mexican");

        categoryOpitonalIsPresent(mexicanCategoryOptional);
    ...
    private void categoryOpitonalIsPresent(Optional<Category> CategoryOptional) {
        if (!CategoryOptional.isPresent()){
            throw new RuntimeException("Expected Category Not Found !");
        }
    }

    private void checkUomIsPresent(Optional<UnitOfMeasure> UomOptional) {
